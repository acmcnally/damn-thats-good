...
- **Monorepo:** pnpm workspaces. No Turborepo/Nx yet — add Turborepo only if/when builds get noticeably slow. Decide source-vs-build-output and cross-package watch when scaffolding `packages/shared` (ADR-0005).
